...
if __name__ == "__main__":
    ...
    fig, subplots = plt.subplots(
        2,
        1,
        figsize=(0.65 * FIG_WIDTH, 0.525 * FIG_WIDTH),
        height_ratios=(1, 16),
    ...
    axes = subplots[0]
    sns.heatmap(
        connectedness.T * 100, ax=axes, cmap="Blues", vmin=0, vmax=100, cbar=False
    )
    axes.set(
        title="Connectedness model", yticks=[], xticklabels=[], xlabel="", ylabel=""
    )
