...
epik="python /grid/mccandlish/home/martigo/programs/epik/bin/EpiK.py -n 0 --train_noise"
...
cmd="$activate $epik $trainx -k $kernel --params $params $gpu_options -o $out --n_lanczos 400 --num_trace_samples 500 --calc_variance --max_contrasts 100"
