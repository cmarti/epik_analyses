...
if __name__ == "__main__":
    ...
    for i in range(1, 40):
        print(i)
        decay_rates = load_decay_rates(dataset, kernel="Exponential", id=i)
    decay_rates = load_decay_rates(dataset, kernel="Connectedness", id=59)
    exit()
    ...
    for seq, bc, ena in zip(backgrounds, bcs, ena1):
        fpath = "output/old/qtls_li_hq.Connectedness.{}_expansion.csv".format(
            seq
        )
