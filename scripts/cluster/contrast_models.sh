...
epik="python /grid/mccandlish/home/martigo/programs/epik/bin/EpiK.py -n 0 --train_noise $gpu_options --max_contrasts 10 --calc_variance --n_lanczos 100 --num_trace_samples 500"
