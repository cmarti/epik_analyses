...
if __name__ == '__main__':
    ...
    bcs_list = [
                ('DEEEIRTTNPVATEQYGSVSTNLQRGNR', 'DEEEIRTTNPVATEQFGSVSTNLQRGNR'), 
    ...
    for axes, bcs, labels in zip(subplots, bcs_list, labels_list):
        df1 = pd.read_csv('output_new/aav.Jenga.{}_expansion.csv'.format(bcs[0]), index_col=0)
        df2 = pd.read_csv('output_new/aav.Jenga.{}_expansion.csv'.format(bcs[1]), index_col=0)
