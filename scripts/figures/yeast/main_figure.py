...
def add_mut_labels(axes, data):
    ...
    dxs = 0.015 * np.array([-0.5, 0.01, 1.4, 0.5, 1])
...
if __name__ == "__main__":
    ...
    axes.legend(loc=4)
    axes.text(-0.45, 1.05, 'A', transform=axes.transAxes, fontsize=12, fontweight='bold')
    ...
    axes.text(-0.35, 1.05, 'C', transform=axes.transAxes, fontsize=12, fontweight='bold')
    ...
    axes.axline((0, 0.0), (0.1, 0.1), linestyle="--", lw=0.5, c="grey", alpha=0.5)
    ...
    axes.set(
        ylabel="Fitness effects\nin ENA1-BY",
        xlabel="Fitness effects\n in ENA1-RM",
        aspect="equal",
        xlim=lims,
        ylim=lims,
        xticks=ticks,
    ...
    axes.text(-0.55, 1.05, 'D', transform=axes.transAxes, fontsize=12, fontweight='bold')
    ...
    axes.text(-0.08, 1.0, 'B', transform=axes.transAxes, fontsize=12, fontweight='bold')
